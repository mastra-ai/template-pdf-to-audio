...
- Google API key (for both summarization and voice synthesis)
...
2. **AI Summarization**: Uses Google GPT-4.1 Mini for intelligent content compression

3. **Voice Synthesis**: High-quality TTS using Google's voice models
...
- Check that Google voice models are available in your region
