...
- Anthropic API key (for both summarization and voice synthesis)
...
2. **AI Summarization**: Uses Anthropic GPT-4.1 Mini for intelligent content compression

3. **Voice Synthesis**: High-quality TTS using Anthropic's voice models
...
- Check that Anthropic voice models are available in your region
